<%-- 
    Document   : issue
    Created on : 9 Nov, 2018, 5:22:57 AM
    Author     : pooji
--%>
         ...
         <table style="border: 2px solid #000000;background-color: #ffcccc">
               <tr>
                   ...
                   <th style="padding: 5px;border:1px solid #000000;">STATUS</th>
                    <th style="padding: 5px;border:1px solid #000000;">ISSUE</th>
               </tr>
           <%
           while(rs.next())
           {
               ...
               %>
               <td style="padding: 5px;border:1px solid #000000;">
                   <button><a href="enter2.jsp?msg=<%= rs.getString("name") %>&amt=<%= rs.getString("amt") %> ">ISSUE</a></button>
               </td>
               </tr>
               <%
           }
